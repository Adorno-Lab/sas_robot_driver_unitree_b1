...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        sas::get_ros_optional_parameter(node, "watchdog_period_in_seconds", watchdog_period, 0.6);
        ...
        sas::get_ros_optional_parameter(node, "watchdog_maximum_acceptable_delay", watchdog_maximum_acceptable_delay, 1e30);
